...
class PartnerController extends Controller
{
	...
	{
		return array(
			array('allow',  // Permite al administrador ejecutar todas las acciones
				'actions'=>array('index','view','Login','create','update','admin','delete'),
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Partner']))
		{
			...
			if($model->save())
				$this->redirect(array('view','id'=>$model->idPartners));
		}
